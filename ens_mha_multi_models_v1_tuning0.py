...
if __name__ == '__main__':
    ...
    for t in range(1):
        ...
        model_name = f'gru_mha_t{t}_WL{wl}_digits_v1'
        base_model = models.load_model(f'models/{model_name}.keras')

        # Extract the output from the second-to-last layer
        intermediate_layer_model = models.Model(base_model.input, base_model.layers[-2].output)
        ...
        history = model.fit(encoder_input, decoder_output, batch_size=batch_size, epochs=100, verbose=1,
